...
public class CuratorBookFunction {
    ...
    public static void lendBookByIsbm(User user, Curator ct) {
        String lendBookIsbm;
        Connection conn = null;
        Book book;
        try {
    ...
    public static void returnBookByIsbm(User user, Curator ct) {
